...
Original file: https://github.com/boltops-pro/rds/blob/master/README.md
...
* You can configure databases like MySQL, PostgreSQL, MariaDB, Microsoft SQL Server, Oracle, etc. For Aurora, refer to the [Aurora Blueprint](https://github.com/boltopspro/aurora).  For Aurora Serverless, refer to the [Aurora Serverless Blueprint](https://github.com/boltopspro/aurora-serverless).
